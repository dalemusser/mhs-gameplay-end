/*
 * MHSCeremonyPlayer v6 — the WORKING version, cloned from v5 (?v=2) for the
 * script-v4 content round (docs/script-v4-plan.md). Presentation is identical
 * to v5; the ONLY functional delta is the versioned voice-clip folder: this
 * player reads assets/audio_v6/ (AUDIO_DIR below) so ceremony_v6.html +
 * ceremony-definition_v6.js play the FINAL script while v1–v5 keep the
 * script-v3 clips in assets/audio/. All new changes land HERE; bump the
 * player_v6.js?v=N buster in ceremony_v6.html on EVERY edit.
 *
...
const EMBLEM_LOGO = { src: 'assets/logo/mhs-logo.png?v=1', aspect: 1378 / 1141 };
...
const LINE_AUDIO = {}, AUDIO_V = 1, AUDIO_DIR = 'assets/audio_v6/';
...
const SFX_ZING = 'assets/sfx/trophy-zing.mp3';   // trophy-lands-in-slot sting (missing file → silent)
...
const MUSIC = { sting: 'assets/sfx/fanfare-award.mp3' };
const CUES = {
  m1:  { src: 'assets/music/m1-cold-open.mp3',   vol: 0.55 },              // Begin → build to an impact (~7s), ducks at Toppo's line
  m2a: { src: 'assets/music/m2a-walkup.mp3',     vol: 0.40, loop: true },  // walk-up grooves — alternate per hand-off,
  m2b: { src: 'assets/music/m2b-walkup.mp3',     vol: 0.40, loop: true },  //   RESUME (not restart) so it's not the same 4 bars every time
  m4:  { src: 'assets/music/m4-riser.mp3',       vol: 0.60 },              // award riser — the hit gates the fanfare/confetti
  m5:  { src: 'assets/music/m5-celebration.mp3', vol: 0.50, loop: true },  // celebration loop, fades with the black-out
};
